...
let usedBottles = numBottles;
let emptyBottles = numBottles;

while (emptyBottles >= numExchange) {
  let temp = Math.floor(emptyBottles / numExchange);
  usedBottles += temp;
  emptyBottles = temp + (emptyBottles - temp * numExchange);
}

console.log(`usedBottles = ${usedBottles}`);
