...
public class sentenceSorting {
    public static void main(String[] args) {
        String s = "is2 sentence4 This1 a3";    // sample Input
        ...
        for(int i=0; i<arrLength; i++) {
            ...
            resultArray[position-1] = words[i].substring(0, words[i].length() -1);
        }

        String result = String.join(" ", resultArray);
        System.out.println("result String = " + result);    // return result;
    }
}
